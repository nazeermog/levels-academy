...
@else <div class="card border-top border-0 border-4 border-primary table-responsive">
  ...
  @else <div class="card border-top border-0 border-4 border-primary table-responsive">
    ...
    <div class="card-header">
      <h3 class="card-title float-left">You should have some courses first.</h3>
      <a href="{{route('admin.courseContent.create')}}" class="btn btn-primary float-right">+ Add New</a>
