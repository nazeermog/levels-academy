                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.org.class_session_types.update', $type->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="teacher_payout" name="teacher_payout" value="{{ old('teacher_payout', number_format($type->teacher_payout, 2, '.', '')) }}" required>
                        </div>
