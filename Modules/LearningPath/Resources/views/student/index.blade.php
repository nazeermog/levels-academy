                ...
                <div class="row card-group-row mb-lg-8pt">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/devops_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/redis_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/mailchimp_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                    ...
                    <div class="col-sm-4 card-group-row__col">
                        ...
                        <div class="popoverContainer d-none">
                            ...
                            <p class="mt-16pt text-70">Learn the fundamentals of working with Angular and how to
                                create basic applications.</p>
                ...
                <div class="row card-group-row mb-lg-8pt">
                    ...
                    <div class="col-sm-4 card-group-row__col">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/sketch_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                        ...
                        <div class="popoverContainer d-none">
                            ...
                            <p class="mt-16pt text-70">Learn the fundamentals of working with Sketch and how to
                                create basic applications.</p>
                    ...
                    <div class="col-sm-4 card-group-row__col">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/flinto_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                        ...
                        <div class="popoverContainer d-none">
                            ...
                            <p class="mt-16pt text-70">Learn the fundamentals of working with Flinto and how to
                                create basic applications.</p>
                    ...
                    <div class="col-sm-4 card-group-row__col">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/photoshop_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                        ...
                        <div class="popoverContainer d-none">
                            ...
                            <p class="mt-16pt text-70">Learn the fundamentals of working with Photoshop and how to
                                create basic applications.</p>
                    ...
                    <div class="col-sm-4 card-group-row__col">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/figma_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                        ...
                        <div class="popoverContainer d-none">
                            ...
                            <p class="mt-16pt text-70">Learn the fundamentals of working with Figma and how to
                                create basic applications.</p>
                    ...
                    <div class="col-sm-4 card-group-row__col">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/xd_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                        ...
                        <div class="popoverContainer d-none">
                            ...
                            <p class="mt-16pt text-70">Learn the fundamentals of working with Adobe XD and how to
                                create basic applications.</p>
                    ...
                    <div class="col-sm-4 card-group-row__col">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/invision_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                        ...
                        <div class="popoverContainer d-none">
                            ...
                            <p class="mt-16pt text-70">Learn the fundamentals of working with inVision App and how
                                to create basic applications.</p>
                    ...
                    <div class="col-sm-4 card-group-row__col">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="{{asset('/images/paths/craft_40x40@2x.png')}}"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                        ...
                        <div class="popoverContainer d-none">
                            ...
                            <p class="mt-16pt text-70">Learn the fundamentals of working with Craft by inVision and
