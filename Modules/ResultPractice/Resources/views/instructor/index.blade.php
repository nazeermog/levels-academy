...
<div class="container py-5">
  ...
  <div class="card border-top border-0 border-4 border-primary table-responsive">
    ...
    <div class="card-body ">
        ...
        <table class="table table-hover">
          <thead>
            <tr>
              ...
              <th>Ebene</th>
              <th>Ergebnis real</th>
              <th>Ergebnis Student</th>
              <th>Dauer</th>
              <th>Kartennummer</th>
              <th>Bereichsnummer</th>
              <th>Gewinner</th>
              @endif
            </tr>
          </thead>
      ...
      <h2>
        @if(session('locale', config('app.locale')) == 'en')
        There Is No Result Practice Yet.
        @endif
        @if(session('locale', config('app.locale')) == 'ar')
         لا توجد نتائج للتمارين بعد.
        @endif
        @if(session('locale', config('app.locale')) == 'de')
        Es gibt noch kein Ergebnistraining.
        @endif
      </h2>
      @endif
    </div>
