                                        ...
                                        class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
                                                            ...
                                                            <span class="row flex-nowrap">
                                                                ...
                                                                <span class="col d-flex flex-column">
                                                                    <span>
                                                                        <span
                                                                            class="card-title text-white mb-4pt d-block">Flinto</span>
                                        ...
                                        class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
                                                            ...
                                                            <span class="row flex-nowrap">
                                                                ...
                                                                <span class="col d-flex flex-column">
                                                                    <span>
                                                                        <span
                                                                            class="card-title text-white mb-4pt d-block">Angular fundamentals</span>
            ...
            <div class="row mb-lg-16pt">
                <div class="col-lg-6 mb-8pt mb-sm-0">
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <p class="mt-16pt text-70">Learn the fundamentals of working with Angular and how to create
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <p class="mt-16pt text-70">Learn the fundamentals of working with Swift and how to create basic
                            applications.</p>
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <p class="mt-16pt text-70">Learn the fundamentals of working with React Native and how to create
                            basic applications.</p>
                            ...
                            <div class="mdk-carousel__content">
                                ...
                                <div class="col-12 col-sm-6">
                                           ...
                                           data-position="">
                                            ...
                                            <span class="overlay__content align-items-start justify-content-start">
                                                                    <span
                                                                        ...
                                                                        <span
                                                                            class="card-title text-white">Resume</span>
                                                                    </span>
                                                                </span>
                                        </a>
                                    ...
                                    <div class="popoverContainer d-none">
                                        ...
                                        <p class="my-16pt text-70">Learn the fundamentals of working with Angular and
                                        ...
                                        <div class="mb-16pt">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="material-icons icon-16pt text-50 mr-8pt">check</span>
                                                <p class="flex text-50 lh-1 mb-0"><small>Testing with Angular</small>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="my-32pt">
                                            <div class="d-flex align-items-center mb-8pt justify-content-center">
                                                <div class="d-flex align-items-center mr-8pt">
                                                    <span
                                                        class="material-icons icon-16pt text-50 mr-4pt">access_time</span>
                                                    <p class="flex text-50 lh-1 mb-0"><small>50 minutes left</small></p>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    <span class="material-icons icon-16pt text-50 mr-4pt">play_circle_outline</span>
