...
$hasOrgBrand = $org || !empty($brandSubdomain);
$brandName = $org && $org->name ? $org->name : ($brandName ?? 'Levels Academy');
$orgLogo = $hasOrgBrand ? ($brandLogo ?? asset('images/logo/Levels-logo.png')) : null;
$tagline = $hasOrgBrand ? 'Bloom into your best self' : 'We will take you to the next';
@endphp
...
<head>
    ...
    <style>
        ...
        :root {
            @if ($hasOrgBrand) --bg: linear-gradient(135deg, #eef8f2 0%, #d3f0e0 100%);
            --accent: #1f7a50;
            --accent-dark: #16593a;
            --accent2: #d996b0;
            ...
            --label: #2f4038;
            --input-bg: #ffffff;
            --input-border: rgba(31, 122, 80, 0.30);
            --title-a: #1f7a50;
            --title-b: #57c99a;
            --btn-a: #1f7a50;
            --btn-b: #3fae7d;
            ...
            @else --bg: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 50%, #1a1a1a 100%);
            --accent: #12a3bb;
            --accent-dark: #0f8a9e;
            --accent2: #667eea;
