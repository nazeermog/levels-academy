    ...
    <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="row"
                    ...
                    <div class="col-auto">
                        <a href="student-paths.html"
                           class="btn btn-outline-secondary">Learning Paths</a>
                    </div>
                </div>
        ...
        <div class="page-section border-bottom-2">
            <div class="container page__container">
                ...
                <div class="card">
                    <img src="{{asset('/images/paths/typescript_892x286.png')}}"
                         alt="TypeScript"
                         class="card-img"
                         style="max-height: 100%; width: initial;">
                    <div class="fullbleed bg-primary"
                         style="opacity: .5;"></div>
                    <img src="{{asset('/images/paths/typescript_64x64.svg')}}"
                         width="64"
                ...
                <div class="d-flex flex-wrap align-items-start">
                    <div class="d-flex align-items-center mr-24pt">
                        <a href="student-take-course.html"
                           class="mr-12pt">
                            <img src="{{asset('/images/paths/angular_64x64.svg')}}"
                                 width="40"
                                 alt="Angular"
                                 class="rounded">
                        </a>
                                        ...
                                        class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
                                                        <span class="row flex-nowrap">
                                                            <span
                                                                ...
                                                                <span
                                                                    class="text-white-60 d-block mb-24pt">Jun 5, 2018</span>
                                                            </span>
